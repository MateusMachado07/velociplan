...
export default function PlanoPage() {
  ...
  useEffect(() => {
    ...
    async function generatePlan() {
      ...
      // 3. Call the AI generation API with a 120-second timeout
      try {
        ...
        setState({
          status: "error",
          message: isTimeout
            ? "A geração do plano demorou demasiado tempo. Tenta novamente — normalmente demora 20-40 segundos."
      ...
      <div className="min-h-screen bg-brand-navy flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-6 text-center">
          ...
          <p className="text-gray-600 text-xs mt-6 max-w-xs">
            ...
            perfil. Isto pode demorar 15-30 segundos.
          </p>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-brand-navy">
      ...
      <nav className="border-b border-white/10 px-6 py-4 sticky top-0 bg-brand-navy/90 backdrop-blur-sm z-10">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <span className="text-xl font-bold gradient-text">VelociPlan</span>
