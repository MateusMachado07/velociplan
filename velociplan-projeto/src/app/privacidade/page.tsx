    ...
    <main className="min-h-screen bg-brand-navy">
      ...
      <article className="px-6 py-16 max-w-2xl mx-auto prose prose-invert prose-sm">
        ...
        <Section title="1. Responsável pelo tratamento">
          <p>O responsável pelo tratamento dos teus dados pessoais é o VelociPlan, contactável através do endereço <a href="mailto:suporte@velociplan.pt" className="text-brand-blue hover:underline">suporte@velociplan.pt</a>.</p>
        </Section>
