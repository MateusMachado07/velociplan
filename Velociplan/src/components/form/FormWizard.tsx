...
// ══════════════════════════════════════════════════════════════════
// STEP 4 — Duração das Sessões
// ══════════════════════════════════════════════════════════════════
function StepDuracao({ data, setData }: StepProps) {
  const options = [
    {
      value: "30min",
      label: "30 minutos",
      icon: "⏱️",
      description: "Sessões curtas mas eficazes. Ideal para dias com pouco tempo.",
    },
    {
      value: "1h",
      label: "1 hora",
      icon: "🕐",
      description: "A duração mais comum para treinos de qualidade.",
    },
    {
      value: "1h30",
      label: "1h 30 minutos",
      icon: "🕜",
      description: "Treinos mais longos com maior carga de trabalho.",
    },
    {
      value: "2h_mais",
      label: "2 horas ou mais",
      icon: "🕑",
      description: "Saídas longas para desenvolver resistência máxima.",
    },
  ];
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
      {options.map((o) => (
        <SelectionCard
          ...
          label={o.label}
          description={o.description}
          selected={data.duracaoSessao === o.value}
          onClick={() =>
            setData((prev) => ({ ...prev, duracaoSessao: o.value }))
          }
        />
      ))}
    </div>
...
// ══════════════════════════════════════════════════════════════════
// STEP 10 — Informação Adicional (campo livre final)
// ══════════════════════════════════════════════════════════════════
...
export default function FormWizard() {
  ...
  function validate(): string {
    switch (step) {
      ...
      case 3:
        ...
        return "";
      case 4:
        if (!data.duracaoSessao)
          return "Por favor seleciona a duração típica das tuas sessões.";
        return "";
      case 5:
  ...
  function handleSubmit() {
    ...
    const payload = {
      ...
      duracaoSessao: data.duracaoSessao,
      ...
      <main className="flex-1 flex flex-col items-center px-6 py-10">
        <div className="w-full max-w-2xl">
          ...
          <div className="mb-6">
            ...
            {step === 4 && <StepDuracao data={data} setData={setData} />}
            {step === 5 && <StepVolume data={data} setData={setData} />}
            {step === 6 && (
            ...
            {step === 9 && <StepLesoes data={data} setData={setData} />}
            {step === 10 && <StepFinal data={data} setData={setData} />}
          </div>
